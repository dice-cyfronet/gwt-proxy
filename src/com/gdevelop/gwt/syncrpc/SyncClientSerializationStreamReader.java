...
public class SyncClientSerializationStreamReader extends AbstractSerializationStreamReader{
  ...
  private static final org.slf4j.Logger log = org.slf4j.LoggerFactory
		.getLogger(SyncClientSerializationStreamReader.class);
  ...
  protected Object deserialize(String typeSignature) throws SerializationException{
    ...
    log.debug("typeSignature is: {}", typeSignature);
    ...
    try {
      ...
      //    false, null);
    	...
    	if (serializationPolicy instanceof TypeNameObfuscator) {
            TypeNameObfuscator obfuscator = (TypeNameObfuscator) serializationPolicy;
            String instanceClassName = obfuscator.getClassNameForTypeId(typeSignature);
            log.debug("discovered class name is: {}", instanceClassName);
            assert (instanceClassName != null) : "class name returned by obduscator for typeSignature=" + typeSignature +" was null";
      ...
      log.debug("reading replacement: {}, {}, {}", new Object [] {customSerializer, instanceClass, instance});
...
//    encoded = encoded.substring(1, encoded.length()-1);
  ...
  private void deserializeClass(Class<?> instanceClass, Object instance)
    ...
    log.debug("deserializing class {}", instanceClass);
    for (Field declField : serializableFields) {
      assert (declField != null);

      log.debug("deserializing field {}", declField);
